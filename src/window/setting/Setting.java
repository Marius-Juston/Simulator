...
//			System.out.println(p.absolutePath());
	...
	void setCheckpointSavePath(String checkpointSavePath) {
	...
	void setMapSaveLocation(String mapSaveLocation) {
	...
	void setCheckpointSaveFrequency(int checkpointSaveFrequency) {
	...
	void setGameDimension(boolean gameDimension) {
		this.gameDimension = gameDimension;
	}
	...
	void setNumberOfGenerationsAtOnce(int numberOfGenerationsAtOnce) {
	...
	public String toString() {
		return "Setting{" +
				...
				", mapSaveLocation='" + mapSaveLocation + '\'' +
				", checkpointSaveFrequency=" + checkpointSaveFrequency +
				", randomSeed=" + randomSeed +
				", gameDimension=" + gameDimension +
				", numberOfGenerationsAtOnce=" + numberOfGenerationsAtOnce +
				", gravity=" + gravity +
				'}';
	}
}
